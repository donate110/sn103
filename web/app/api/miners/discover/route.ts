...
export async function GET() {
  try {
    ...
    const miners = nodes.map((n) => ({ uid: n.uid, ip: n.ip, port: n.port, hotkey: n.hotkey, stake: n.totalStake.toString(), alphaStake: n.alphaStake.toString(), taoStake: n.taoStake.toString(), incentive: n.incentive, emission: n.emission.toString(), rank: n.rank }));
