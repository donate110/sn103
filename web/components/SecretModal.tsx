...
export default function SecretModal({ open, title, message, variant = "local", footer, children }: SecretModalProps) {
  ...
  const config = {
    local: {
      ...
      badge: "Processing locally on your device",
      defaultFooter: "Your data never leaves this device during this step.",
      icon: (
    ...
    network: {
      ...
      defaultFooter: "Verifying your lines are available. Your real pick is hidden among decoys.",
      icon: (
    ...
    distribute: {
      ...
      badge: "Distributing to validators",
      defaultFooter: "Key shares are sent to validators. Your full key never leaves this device.",
      icon: (
