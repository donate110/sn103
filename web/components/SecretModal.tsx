...
export default function SecretModal({ open, title, message, variant = "local", footer, children }: SecretModalProps) {
  ...
  const config = {
    ...
    network: {
      ...
      defaultFooter: "Querying miners to independently verify line availability. Your real pick is hidden among decoys.",
      icon: (
    ...
    distribute: {
      ...
      defaultFooter: "Splitting your encryption key into shares via Shamir secret sharing and distributing them to validators. Your full key never leaves this device.",
      icon: (
